...
public class Main {
	...
	static {
		parserMap.put("uml", new UMLEndParser(new UMLSingletonParser(new UMLAssociationParser(new UMLUsesParser(new UMLImplementsParser(new UMLExtendsParser(new UMLParser())))))));
