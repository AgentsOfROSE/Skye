...
public class Main {
	...
	static {
		parserMap.put("uml", new UMLEndParser(new UMLAdapterParser(new UMLDecoratorParser(new UMLSingletonParser(new UMLUsesParser(new UMLAssociationParser(new UMLImplementsParser(new UMLExtendsParser(new UMLParser())))))))));
