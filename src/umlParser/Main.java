...
public class Main {
	...
	static {
		parserMap.put("uml", new UMLEndParser(new UMLSingletonParser(new UMLUsesParser(new UMLAssociationParser(new UMLImplementsParser(new UMLExtendsParser(new UMLParser())))))));
