...
public class SnowmanSprite extends AbstractSprite {
	...
	public SnowmanSprite(double x, double y, double width, double height) {
		...
		spriteComponents.add(new CircleSprite(x+width/4, y, width/2, height/3));
		spriteComponents.add(new CircleSprite(x+width/6, y + height /3, 2*width/3, height/3));
		spriteComponents.add(new CircleSprite(x, y + 2* height /3, width, height/3));
	}
